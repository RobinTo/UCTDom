...
for turnPoint in range(10, 31):
	print("Turnpoint " + str(turnPoint))
	for i in range(0, 1000):
		...
		while gameC < 20:
			...
			while turns < 40:
				...
				nextCard = getNextOption(c, turnPoint)
			...
			f = open('treasure'+str(turnPoint)+'victory.txt', 'a+')
