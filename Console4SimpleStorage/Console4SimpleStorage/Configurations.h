// Testing
#define GAMES				1000
#define PRINTTREE			1	// Possibly is something wrong. Check if hand in rootnode is correct. TODO.
...
#define AVERAGEPROPAGATE		0		// Whether to use 'old' averaging- or the 'new' best-propagation
